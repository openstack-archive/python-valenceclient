...
class TestComposeNode(test_base.TestValenceClient):
    def test_compose_node(self):
        ...
        resp = node_client.Node(self, response)
        mocker = mock.Mock(return_value=resp)
        self.valenceclient.nodes.compose_node = mocker
...
class TestShowNode(test_base.TestValenceClient):
    ...
    def test_show_node(self):
        ...
        resp = node_client.Node(self, response)
        mocker = mock.Mock(return_value=resp)
        self.valenceclient.nodes.show_node = mocker
...
class TestDeleteNode(test_base.TestValenceClient):
    def test_delete_node(self):
        ...
        self.valenceclient.nodes.delete_node = mocker
...
class TestManageNode(test_base.TestValenceClient):
    def test_manage_node(self):
        ...
        resp = node_client.Node(self, response)
        mocker = mock.Mock(return_value=resp)
        self.valenceclient.nodes.manage_node = mocker
...
class TestListNodes(test_base.TestValenceClient):
    def test_list_nodes(self):
        ...
        resp = [node_client.Node(self, res) for res in response]
        mocker = mock.Mock(return_value=resp)
        self.valenceclient.nodes.list_nodes = mocker
