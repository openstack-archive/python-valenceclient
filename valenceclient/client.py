...
def get_client(valence_url, valence_api_version=None, max_retries=None,
               retry_interval=None):

    if valence_url is None:
        raise exc.InvalidValenceUrl
    valence_api_version = valence_api_version if valence_api_version \
        else DEFAULT_VERSION

    kwargs = {
        'valence_url': valence_url,
        'valence_api_version': valence_api_version,
