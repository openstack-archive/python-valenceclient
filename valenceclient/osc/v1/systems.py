...
class ListSystems(command.Lister):
    ...
    def take_action(self, parsed_args):
        ...
        obj = client.list_systems(req)
        columns = ('uuid', 'name', 'power_state', 'links')
...
class ShowSystem(command.ShowOne):
    ...
    def take_action(self, parsed_args):
        ...
        client = self.app.client_manager.valence
        obj = client.list_system_by_id(parsed_args.id, req)
        columns = ('uuid', 'name', 'power_state', 'links', 'description',
                   'health', 'chassis_id', 'assettag', 'url_id',
